...
print(f"Do ordinace prislo {no_of_females} zen a {len(rodna_cisla) - no_of_females} muzu.")
...
print(f"Nejstarsi pacient se narodil {oldest % 100}. {(oldest // 100) % 100}. 19{oldest // 10_000}")
print(f"Nejmladsi pacient se narodil {youngest % 100}. {(youngest // 100) % 100}. 19{youngest // 10_000}")
